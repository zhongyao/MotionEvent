 ...
 *
 * 三层View，从外到内依次为： LayoutView1、LayoutView2、MyTextView3。
...
public class MotionEventActivity extends Activity {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                Log.d(TAG, "Activity--onTouchEvent action:ACTION_DOWN");
                break;
            case MotionEvent.ACTION_MOVE:
                Log.d(TAG, "Activity--onTouchEvent action:ACTION_MOVE");
                break;
            case MotionEvent.ACTION_UP:
                Log.d(TAG, "Activity--onTouchEvent action:ACTION_UP");
                break;
            default:
                break;
        }
